...
try:
    ...
    from backend.services.gleif_service import GLEIFClient, GLEIFService
    ...
    print("✓ GLEIFClient instantiated")

    gleif_service = GLEIFService()
    print("✓ GLEIFService (backward compatibility) instantiated")
